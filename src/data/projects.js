const projects = [
  {
    ...
    "description": "A comprehensive, AI-integrated campaign management dashboard designed for advertising agencies, featuring real-time campaign performance analytics, AI-assisted creative brief generation, and instant WebSocket alerts.",
    "features": [
  ...
  },
  {
    ...
    "description": "A powerful multi-cloud storage manager that provides a unified, secure dashboard to search, organize, and sync files across Google Drive, OneDrive, and more.",
    "features": [
  ...
  },
  {
    ...
    "description": "A modern, full-stack SaaS application built to digitize and manage the student discipline workflow of Islamic educational institutions with Urdu RTL support.",
    "features": [
  ...
  },
  {
    ...
    "description": "A content and profile management workspace featuring RESTful APIs, reactive components, and responsive database management using Laravel and Vue.js.",
    "features": [
  ...
  },
  {
    ...
    "description": "A premium, luxury e-commerce web application featuring real-time search, dynamic category routing, and comprehensive cart operations.",
    "features": [
  ...
  },
  {
    ...
    "description": "A lightweight, real-time desktop hardware monitoring system utility that visualizes CPU usage, memory, and device stats.",
    "features": [
  ...
  },
  {
    ...
    "description": "A responsive social media feed application built to demonstrate React design patterns, authentication simulation, and error boundaries.",
    "features": [
  ...
  },
  {
    ...
    "description": "A full-stack practice sandbox designed to experiment with Composition API, REST CRUD endpoints, and asynchronous file uploads.",
    "features": [
  ...
  },
  {
    ...
    "description": "A pixel-perfect design recreation of the Spotify Web Player layout, built to demonstrate CSS Flexbox mastery and structured semantic HTML.",
    "features": [
  ...
  },
  {
    ...
    "description": "A real-time cryptocurrency trading terminal utilizing live WebSocket streams, technical analysis charts, and an automated portfolio ledger simulator.",
    "features": [
  ...
  },
  {
    ...
    "description": "A responsive personal developer portfolio featuring smooth navigation, a dynamic project gallery, and local-storage task tracking.",
    "features": [
  ...
  },
  {
    ...
    "description": "An animated portfolio website with a cyber-noir theme, highlighting personal achievements, skills grid, and visual career timelines.",
    "features": [
  ...
  },
  {
    ...
    "description": "An interactive project organizer utility that allows developers to rank, sort, and organize portfolio items dynamically.",
    "features": [
  ...
  },
  {
    ...
    "description": "A gamified note-to-quiz parser app that extracts definitions from notes and builds interactive quizzes with telemetry.",
    "features": [
  ...
  },
  {
    ...
    "description": "A distraction-free speech reader, teleprompter, and pronunciation evaluator utilizing native browser audio capabilities.",
    "features": [
  ...
  },
  {
    ...
    "description": "A smart asset utility linking photo searches to front-end development outputs with canvas-based palette harvesting and WCAG verification.",
    "features": [
  ...
  },
  {
    ...
    "description": "A currency intelligence dashboard built with dynamic Chart.js trends, market watch alerts, and live currency rates.",
    "features": [
  ...
  },
  {
    ...
    "description": "A dynamic weather dashboard providing real-time forecasts, GPS geolocation search, and interactive floating particle designs.",
    "features": [
  ...
  },
  {
    ...
    "description": "A futuristic task management ecosystem featuring mission nodes, operational pulse statistics, and stateful tracking.",
    "features": [
  ...
  },
  {
    ...
    "description": "A glassmorphic task tracker featuring particle backdrops, task list categorization, and local-storage data persistence.",
    "features": [
  ...
  },
  {
    ...
    "description": "A cryptographic password utility generating highly customized passwords and packaging them instantly into scannable secure QR codes.",
    "features": [
  ...
  },
  {
    ...
    "description": "A celestial orbital clock app mapping time metrics to orbital paths, built with React and advanced motion components.",
    "features": [
  ...
  },
  {
    ...
    "description": "A responsive React calculator highlighting modern interactive 3D physics, glassmorphic layout, and complete keyboard integrations.",
    "features": [
  ...
  },
  {
    ...
    "description": "An analytical lifespan metrics audit reporting exact birthdays, age statistics down to seconds, zodiac data, and astronomical parameters.",
    "features": [
  ...
  },
  {
    ...
    "description": "A customizable digital alarm clock showing dynamic time feeds, integrated alarm management alerts, and multiple design layers.",
    "features": [
  ...
  },
  {
    ...
    "description": "A modern representation of the classic rock-paper-scissors game built with premium glassmorphism layouts and scoreboard metrics.",
    "features": [
  ...
  },
  {
    ...
    "description": "A responsive Tic-Tac-Toe game detailing clean state transitions, win checks, and UI resets.",
    "features": [
  ...
  },
  {
    ...
    "description": "A static design project replicating the complex layout of the Amazon homepage, utilizing header dropdowns and nested product grids.",
    "features": [
  ...
  },
  {
    ...
    "description": "A foundational layout demonstrating CSS Flexbox mechanics, featuring responsive sections and dynamic column flex wrap adjustments.",
    "features": [
